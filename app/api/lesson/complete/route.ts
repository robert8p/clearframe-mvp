...
export async function POST(req: Request) {
  try {
    ...
    if (!existing) {
      ...
      await admin.from("analytics_events").insert({ user_id: user.id, event_name: "daily_lesson_completed", properties: { lesson_id: lesson.id, lesson_slug: lesson.slug, lesson_date: day, xp_awarded: xpEarned } });
    }
