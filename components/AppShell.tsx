...
const consumerItems = [["/dashboard", "Home", "home"], ["/skills", "Skills", "explore"], ["/progress", "Progress", "progress"], ["/settings", "Profile", "profile"]] as const;
