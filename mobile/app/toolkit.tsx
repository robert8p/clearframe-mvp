...
export default function ToolkitScreen() {
  ...
  const clear = () => Alert.alert("Clear saved ideas and rhythm?", "Remove saved ideas, this device’s practice-day record and your weekly target. Your online account, answers and scores are not affected.", [{ text: "Keep", style: "cancel" }, { text: "Clear device tools", style: "destructive", onPress: () => { void tools.clear().catch(() => undefined); } }]);
  return <Screen><Eyebrow>Saved / recommended</Eyebrow><Title size={31}>Saved ideas</Title><Body muted>Revisit an idea before your next decision. These notes and weekly rhythm live privately on this device.</Body><DeviceToolsNotice />
