...
export default async function SessionCompletePage() {
  ...
  return (
    <div className="cg-mobile-page cg-results-screen">
      ...
      <div className="cg-result-stats"><div><small>Alignment</small><strong>{alignment}%</strong></div><div><small>Confidence</small><strong>{averageConfidence}%</strong></div><div><small>Streak</small><strong>{profile?.current_streak ?? 0}</strong></div></div>
