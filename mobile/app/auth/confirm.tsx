...
export default function ConfirmEmailScreen() {
  ...
  return <Screen contentStyle={{ flexGrow: 1, justifyContent: "center" }}><Card><Title size={28}>We couldn’t confirm that link</Title><Body muted>The link may have expired or already been used. Try signing in. Contact support if you still cannot access your account.</Body><PrimaryButton label="Go to sign in" onPress={() => router.replace("/login")} /></Card></Screen>;
}
